        ...
        <Row gutter={[32, 32]}>
          <Col flex={2}>
            <Card className='!bg-[#F7F7F7]'>
              <Meta
                avatar={<Avatar shape='square' src={data_course?.center?.imageUrl} size={128} />}
                title={
                  <Space>
                    <Text>
                      <svg
                ...
                description={
                  <div style={{ marginTop: '-5px' }}>
                    <div className='mb-1'>
                      <Text className='font-semibold text-base'>{data_course?.center?.fullName}</Text>
                    </div>
              ...
              <Flex gap={20} className='bg-[#FFFFFF] mt-7' style={{ background: '#F7F7F7' }}>
