...
export const CourseApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        apiV1KhoaHocIdNguoiHocGet: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v1/khoa-hoc/{id}/nguoi-hoc`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        apiV1KhoaHocPagingGet: async (page?: number, size?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const CourseApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiV1KhoaHocIdNguoiHocGet(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserCourseDtoListResult>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiV1KhoaHocIdNguoiHocGet(id, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CourseApi.apiV1KhoaHocIdNguoiHocGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async apiV1KhoaHocPagingGet(page?: number, size?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CourseViewModelListResult>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiV1KhoaHocPagingGet(page, size, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CourseApi.apiV1KhoaHocPagingGet']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export class CourseApi extends BaseAPI {
    ...
    public apiV1KhoaHocIdNguoiHocGet(id: string, options?: RawAxiosRequestConfig) {
        return CourseApiFp(this.configuration).apiV1KhoaHocIdNguoiHocGet(id, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public apiV1KhoaHocPagingGet(page?: number, size?: number, options?: RawAxiosRequestConfig) {
        return CourseApiFp(this.configuration).apiV1KhoaHocPagingGet(page, size, options).then((request) => request(this.axios, this.basePath));
    }
